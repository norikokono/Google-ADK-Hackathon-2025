...
const ChatApp = () => {
  ...
  // Then in a separate useEffect, show the help message once we have the greeting
  useEffect(() => {
    // Now show the welcome HELP message after initial greeting (when we have exactly 1 message)
        ...
        <div className="chat-container">
          ...
          <div className="chat-input">
            <input
              ...
              autoFocus
              disabled={isLoading} // Actually use isLoading
            />
            <button
              ...
              disabled={isLoading} // Actually use isLoading
            >
              {isLoading ? "Sending..." : "Send"} {/* Actually use isLoading */}
            </button>
          </div>
        </div>
      ) : (
